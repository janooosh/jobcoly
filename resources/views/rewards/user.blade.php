...
<div class="row">
    ...
    <div class="alert alert-warning">
        <p>Es gilt das hier verlinkte Entlohnungsmodell. Die auf dieser Seite dargestellten Rechnungen hier können in Einzelfällen abweichen. </p>
</div>
    </div>
</div>
...
<hr />
@if(count($assignments)<1) <div class="row">
    <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="alert alert-danger">
                    ...
                    <p>Du sammelst Solidaritätsstunden und hast weniger als 16 Stunden gearbeitet. Daher erhälst du nur 50% der angezeigten Gutscheine.</p>
    ...
    <div class="row">
        <div class="col-md-12">
            <form method="POST" action='{{route('rewards.save')}}'>
                ...
                <br /><br />
                <p>Du kannst Zeiteingaben jederzeit <b>speichern</b>. Das ist noch keine finale Auswahl und gibt dir die Möglichkeit, auf die Bestätigung von noch offenen Schichten zu warten oder dir alles noch einmal in Ruhe zu überlegen 🙂<br />
    ...
    <div class="row">
        <div class="col-md-12">
            @if(count($transactions)<1) <p>Noch keine Ausgaben erfasst.</p>
                @else
