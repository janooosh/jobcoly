...
<form method="post" action="{{ route('jobs.update', $job->id)}}">
    ...
    <div class="row">
        ...
        <div class="col-md-2 form-group" style="padding-bottom: 20px">
            ...
            <select class="form-control" id="jobextern" name="jobextern" autofocus>
                ...
                <option value="1" {{$job->is_extern=='1'?'selected':''}}>Ja</option>
                <option value="0" {{$job->is_extern=='0'?'selected':''}}>Nein</option>
            </select>
        </div>
    </div>
    <div class="row p-10">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            Änderungen an den Gutscheinen bzw. der AWE ändern NUR die Vorschläge bei neuen Schichten, nicht aber bestehende Schichten. Sei hier also bitte ein bisschen vorsichtig.
        </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-4 form-group" style="padding-bottom: 20px">
            ...
            <input class="form-control" type="number" id="jobvorbehalt" name="jobvorbehalt" value="{{$job->p}}" required autofocus />
        </div>
